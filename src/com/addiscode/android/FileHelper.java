...
public class FileHelper extends SQLiteOpenHelper{
	private final String tag = "FILE_HELPER";
    //The Android's default system path of your application database.
    private static String DB_PATH = "/data/data/com.addiscode.android/databases/";
 
    private static String DB_NAME = "EthiopianCalendarDb";
  ...
  /**
    ...
    private synchronized void copyDataBase() throws IOException{
    	...
    	Log.i(tag, "Finished database embedding: " + length);
    	//Close the streams
    	myOutput.flush();
    	myOutput.close();
    	myInput.close();
