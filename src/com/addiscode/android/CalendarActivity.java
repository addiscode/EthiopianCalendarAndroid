...
public class CalendarActivity extends Activity implements View.OnClickListener,
	...
	private int currentYear, currentMonth, currentDay, selectedYear,
			selectedMonth, selectedDay, weekDay;
	private String[] days = { "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat" };
	private String[] ethMonths = { "Meskerem", "Tikimit", "Hidar", "Tahisas",
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		todayLabel.setText("Today is " + values[2] + ", "
				+ ethMonths[values[1] - 1] + " " + values[0]);
	...
	public void drawCalendar(int year, int month) {
		...
		eventsThisMonth = dbHandler.getEventsInMonth(selectedYear,
				selectedMonth);
		...
		calendarTable.addView(tr, new TableLayout.LayoutParams(
	...
	public boolean onContextItemSelected(MenuItem item) {
		Toast.makeText(context, "Item: " + item.getTitle(), Toast.LENGTH_SHORT)
				.show();
	...
	public void onClick(View v) {
		...
		case R.id.nextYearBtn:
			...
			break;
		default:
			Toast.makeText(context, "view id: " + v.getId(), Toast.LENGTH_SHORT)
					.show();
			break;
		}
	}
	 ...
	 * 
	 * @see
	 * com.addiscode.android.SimpleGestureFilter.SimpleGestureListener#onSwipe
	 * (int)
	 */
	 ...
	 * 
	 * @see
	 * com.addiscode.android.SimpleGestureFilter.SimpleGestureListener#onDoubleTap
	 * ()
	 */
